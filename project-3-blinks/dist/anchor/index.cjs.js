...
const VOTING_PROGRAM_ID = new web3_js.PublicKey(VotingIDL.address);
// This is a helper function to get the Voting Anchor program.
function getVotingProgram(provider) {
    return new anchor.Program(VotingIDL, provider);
}
...
function getVotingProgramId(cluster) {
    switch(cluster){
        ...
        case 'testnet':
            ...
            return new web3_js.PublicKey('6RMzzoy8iRv9a6ATQbxva3p5GCLFtBukjVN195aBNmQ8');
        case 'mainnet-beta':
        default:
...
exports.VOTING_PROGRAM_ID = VOTING_PROGRAM_ID;
exports.VotingIDL = VotingIDL;
exports.getVotingProgram = getVotingProgram;
exports.getVotingProgramId = getVotingProgramId;
